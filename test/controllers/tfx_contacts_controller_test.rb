...
class TfxContactsControllerTest < ActionController::TestCase
  ...
  test "should create tfx_contact" do
    assert_difference('TfxContact.count') do
      post :create, tfx_contact: { Email: @tfx_contact.Email, Expires: @tfx_contact.Expires, FirstName: @tfx_contact.FirstName, LastName: @tfx_contact.LastName, Password: @tfx_contact.Password, Phone: @tfx_contact.Phone, UserID: @tfx_contact.UserID }
    end
  ...
  test "should update tfx_contact" do
    patch :update, id: @tfx_contact, tfx_contact: { Email: @tfx_contact.Email, Expires: @tfx_contact.Expires, FirstName: @tfx_contact.FirstName, LastName: @tfx_contact.LastName, Password: @tfx_contact.Password, Phone: @tfx_contact.Phone, UserID: @tfx_contact.UserID }
    assert_redirected_to tfx_contact_path(assigns(:tfx_contact))
  end
